        ...
        <div className='container'>
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" name='geolocation' value={credentails.geolocation} onChange={onChange} id="exampleInputPassword1" />
                </div>
                <button type="submit" className="m-3 btn btn-outline-success">Submit</button>
                <Link to ="/login" className = 'm-3 btn btn-outline-primary' role='button'>Already User</Link>
            </form>
            </div>
        </>
    )
